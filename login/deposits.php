...
<title>Deposits || Crypto-Genius</title>
...
<li class="active">
<a href="#">
<img src="../data/creditcard-1.png" width="24px" id="creditcard">&nbsp; My deposits</a>
</li>
<li class="">
...
<h1 style="text-align: center;">Your Deposits</h1>
<div class="my-stat">
<div class="container">
...
for ($i = 0; $i < $rown; $i++){
  ...
  $amo = (float) $amo;
  $acc = $amo*2;
  $date = date('Y-m-d h:i', strtotime($sd. ' + 1 day')); 
  $sd = date_create($sd);
  ...
  $sd = date_format($sd,"Y-m-d h:i");
  echo "<tr><td>$sd</td><td>$date</td><td>$amo</td><td>$acc</td><td>$status</td></tr>";
}
?>
</tbody>
</table>
